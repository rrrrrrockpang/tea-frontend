...
const createDependentVariableBtn = (inputForm) => {
    ...
    initialBtn.on("click", function() {
        ...
        const construct = inputForm.find(".construct-name").val(); // TODO: Add this
...
<!--                    </div>-->
                    ...
                    <div class="form-group">
                        <h4 for='variable-name' class='col-form-label'>What construct does this variable measure?<span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="top" title="You can select the construct in the question above and right click it."></span></h4>
