const addTeaFloatingBtn = () => {
    return btn = $(`
        <button id="tea-floating-btn" class="preregistea-container floating-btn" data-toggle="modal" data-target="#exampleModal">Tea Code</button>
    `);
}
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="save" class="btn btn-success" data-dismiss="modal">Save</button>
