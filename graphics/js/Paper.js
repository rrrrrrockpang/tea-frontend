class Paper {
    constructor() {
        ...
        this.content =
            [
                {
                    "component": "independent_variable",
                    "description": "&emsp; We designed our first experiment to measure differences in " +
                ...
                {
                    "component": "",
                    "description": "&emsp; In theory these presentations contain the same information " +
                ...
                },
                {
                    ...
                    "description": "We also used this experiment to investigate whether differences between visualization formats can be mitigated by simply adding extra text in the captions that appear alongside a\n" +
    ...
    addPaper(div) {
        for(let i = 0; i < this.content.length; i++) {
            let sentenceId = "sentence_" + i;
             if(this.content[i]["component"].length > 0) {
                let sentence = new Sentence(sentenceId, this.content[i]["description"]);
